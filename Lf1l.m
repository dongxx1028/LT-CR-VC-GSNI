...
% When Lf1l=0.1,0.175,0.25,0.325,0.4, reverse solution of Laplace space  concentration of contaminants at the wellhead (equation (91)) to real space concentration of contaminants
...
% Code for equations£¨80£©-£¨81£©
       d1=a1*(1/(2*n)-1)*Lf1l(k)+e1-c1*h1^2;
...
% Code for the concentration of contaminanton on the left wing of the first fracture: equation£¨86£©
        Cf1L=(exp(lambda2L*(1-1/(2*n))*Lf1l(k))*(q1+(lambda1L*a1*(1/(2*n)-1)*Lf1l(k)+a1+e1*lambda1L)/...
           ((lambda2L-lambda1L)*lambda1L^2)+(lambda2L*a1*(1/(2*n)-1)*Lf1l(k)+a1+e1*lambda2L)/((lambda1L-lambda2L)*lambda2L^2))...
...
legend('$$L_{f1l}=0.1 $$','$$ L_{f1l}=0.175 $$','$$ L_{f1l}=0.25 $$','$$ L_{f1l}=0.325 $$','$$ L_{f1l}=0.4 $$','Interpreter','latex')
box off  
grid on   