...
% Reverse solution of Laplace space  concentration of contaminants at the wellhead (equation (91)) to real space concentration of contaminants at the wellhead (equation (92)) 
for k=1:5
   for i=1:LL
      ft(i,k)=0;
      u=log(2)/t(i);
